...
--
-- Name: chatbot_cart; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.chatbot_cart (
    id bigint NOT NULL,
...
ALTER TABLE public.chatbot_cart OWNER TO postgres;

--
-- Name: chatbot_cart_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.chatbot_cart ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.chatbot_cart_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: chatbot_message; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.chatbot_message OWNER TO postgres;

--
-- Name: chatbot_message_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.chatbot_message ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.chatbot_message_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: chatbot_session; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.chatbot_session (
    id bigint NOT NULL,
...
ALTER TABLE public.chatbot_session OWNER TO postgres;

--
-- Name: chatbot_session_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.chatbot_session ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.chatbot_session_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: chatbot_cart chatbot_cart_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_cart
    ADD CONSTRAINT chatbot_cart_pkey PRIMARY KEY (id);


--
-- Name: chatbot_message chatbot_message_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: chatbot_session chatbot_session_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_session
    ADD CONSTRAINT chatbot_session_pkey PRIMARY KEY (id);


--
-- Name: chatbot_session chatbot_session_session_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_session
    ADD CONSTRAINT chatbot_session_session_id_key UNIQUE (session_id);
...
--
-- Name: chatbot_cart_food_id_2b38203e; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX chatbot_cart_food_id_2b38203e ON public.chatbot_cart USING btree (food_id);


--
-- Name: chatbot_cart_food_size_id_4d3c719f; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX chatbot_cart_food_size_id_4d3c719f ON public.chatbot_cart USING btree (food_size_id);


--
-- Name: chatbot_cart_session_id_c7933ff3; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX chatbot_cart_session_id_c7933ff3 ON public.chatbot_cart USING btree (session_id);


--
-- Name: chatbot_message_session_id_cb245dab; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX chatbot_message_session_id_cb245dab ON public.chatbot_message USING btree (session_id);


--
-- Name: chatbot_session_session_id_b85a9487_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX chatbot_session_session_id_b85a9487_like ON public.chatbot_session USING btree (session_id varchar_pattern_ops);


--
-- Name: chatbot_session_user_id_36114853; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX chatbot_session_user_id_36114853 ON public.chatbot_session USING btree (user_id);
...
--
-- Name: chatbot_cart chatbot_cart_food_id_2b38203e_fk_food_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_cart
    ADD CONSTRAINT chatbot_cart_food_id_2b38203e_fk_food_id FOREIGN KEY (food_id) REFERENCES public.food(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: chatbot_cart chatbot_cart_food_size_id_4d3c719f_fk_food_size_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_cart
    ADD CONSTRAINT chatbot_cart_food_size_id_4d3c719f_fk_food_size_id FOREIGN KEY (food_size_id) REFERENCES public.food_size(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: chatbot_cart chatbot_cart_session_id_c7933ff3_fk_chatbot_session_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_cart
    ADD CONSTRAINT chatbot_cart_session_id_c7933ff3_fk_chatbot_session_id FOREIGN KEY (session_id) REFERENCES public.chatbot_session(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: chatbot_message chatbot_message_session_id_cb245dab_fk_chatbot_session_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_message
    ADD CONSTRAINT chatbot_message_session_id_cb245dab_fk_chatbot_session_id FOREIGN KEY (session_id) REFERENCES public.chatbot_session(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: chatbot_session chatbot_session_user_id_36114853_fk_users_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chatbot_session
    ADD CONSTRAINT chatbot_session_user_id_36114853_fk_users_id FOREIGN KEY (user_id) REFERENCES public.users(id) DEFERRABLE INITIALLY DEFERRED;
