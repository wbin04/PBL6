...
const StoreManager: React.FC = () => {
  const [activeSection, setActiveSection] = useState<string>(
    () => localStorage.getItem("store_manager_active_section") || "dashboard"
  );
  ...
  const [selectedPromo, setSelectedPromo] = useState<StorePromotion | null>(
    null
  );
  ...
  const [editableStoreInfo, setEditableStoreInfo] = useState<MyStore | null>(
    null
  );
  ...
  const handleUpdateSize = async (sizeId: number) => {
    ...
    try {
      await API.put(
        `/menu/store/foods/${selectedFood.id}/sizes/${sizeId}/`,
        editingSizeData
      );
      ...
      const errorMsg = error?.message || "Không thể cập nhật";
      alert(`Lỗi: ${errorMsg}`);
    }
  };
  ...
  const updateOrderStatus = async (orderId: number, status: string) => {
    if (!storeInfo) return;
    try {
      await API.patch(`/stores/${storeInfo.id}/orders/${orderId}/status/`, {
        order_status: status,
      });
  ...
  const inputClass =
    "w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white";
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white border-r shadow-sm hidden md:flex flex-col flex-shrink-0 z-20">
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          <p className="text-xs font-bold text-gray-400 uppercase px-4 mb-3 mt-2 tracking-wider">
            Tổng quan
          </p>
          <button
          ...
          <p className="text-xs font-bold text-gray-400 uppercase px-4 mt-6 mb-3 tracking-wider">
            Quản lý
          </p>
          <button
          ...
          <div className="flex items-center gap-3 px-2 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-medium text-sm text-gray-900 truncate">
                {storeInfo?.manager?.fullname || "Người dùng"}
              </p>
        ...
        <header className="h-16 bg-white border-b shadow-sm flex items-center justify-between px-6 flex-shrink-0 z-10">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              <span className="hidden sm:inline">Trang Khách Hàng</span>
            </Button>
              ...
              <div className="animate-in fade-in duration-500">
                ...
                <div className="flex gap-3 mb-6 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                  <input
                    ...
                    className="border border-gray-200 p-2 rounded-lg flex-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <select
                  ...
                  <Button onClick={() => loadFoods(1)} variant="secondary">
                    Lọc
                  </Button>
                </div>
                      ...
                      <tbody className="divide-y">
                        {orders.map((order) => (
                          <tr
                            ...
                            <td className="p-4">
                              <span
                                className={`px-3 py-1 text-xs rounded-full font-medium shadow-sm ${getStatusClass(
                                  order.order_status
                                )}`}>
                                {order.order_status}
                              </span>
              ...
              <div className="animate-in fade-in duration-500">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 shadow-sm">
                    <Plus size={18} className="mr-2" /> Tạo khuyến mãi
                  </Button>
                </div>
                <Card className="border-0 shadow-sm">
                  <CardContent className="p-0 overflow-hidden rounded-lg border">
                  ...
                  <CardContent className="p-8 relative bg-white">
                    <div className="absolute -top-20 left-8 p-1.5 bg-white rounded-2xl shadow-lg">
                      <img
                        ...
                        className="w-36 h-36 object-cover rounded-xl border border-gray-100"
                      />
                    </div>
                      ...
                      <div className="space-y-6">
                        <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
                          <h4 className="font-bold text-blue-900 mb-4 flex items-center gap-2">
                            <CheckCircle size={18} /> Thông tin quản lý
                          </h4>
                          <div className="space-y-4">
                            <div className="flex border-b border-blue-100 pb-3">
                              <div className="w-32 text-sm text-blue-600">
                                Họ và tên
                              </div>
                              {/* FIX: thêm ?. */}
                              <div className="font-medium text-gray-800">
                                {storeInfo.manager?.fullname}
                              </div>
                            </div>
                            <div className="flex border-b border-blue-100 pb-3">
                              <div className="w-32 text-sm text-blue-600">
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
            <div className="flex justify-between items-center px-6 py-4 border-b bg-gray-50">
              <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                <Utensils size={20} className="text-blue-600" /> Thêm món ăn mới
              </h2>
              <button
                ...
                <div>
                  ...
                  <div
                    ...
                    <p className="text-sm text-gray-600">
                      {newFoodImage ? newFoodImage.name : "Nhấn để tải ảnh lên"}
                    </p>
                  </div>
                </div>
              </form>
      ...
      {showEditFoodModal && selectedFood && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
            <div className="flex justify-between items-center px-6 py-4 border-b bg-gray-50">
              <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                <Edit2 size={20} className="text-blue-600" /> Chỉnh sửa món ăn
              </h2>
              <button
              ...
              <form
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      required
                      value={selectedFood.category?.id}
                      onChange={(e) =>
                        setSelectedFood({
                          ...selectedFood,
                          category: {
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <img
                      src={getImageUrl(selectedFood.image_url)}
                      className="w-16 h-16 rounded object-cover border"
                      alt="Current"
                    />
                    <div
                      className="flex-1 border-2 border-dashed border-gray-300 rounded-lg p-3 text-center hover:bg-gray-50 cursor-pointer"
                      ...
                      <p className="text-sm text-gray-500">
                        {editFoodImage ? editFoodImage.name : "Chọn ảnh khác"}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden">
            ...
            <div className="p-6">
              <form
                ...
                className="flex gap-2 mb-6 items-end bg-blue-50/50 p-3 rounded-lg border border-blue-100">
              ...
              <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1 custom-scrollbar">
                {foodSizes.length > 0 ? (
                  foodSizes.map((size) => (
                    <div
                      key={size.id}
                      className="flex justify-between items-center p-3 bg-white rounded-lg border hover:shadow-sm transition-shadow group">
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
            <div className="flex justify-between items-center px-6 py-4 border-b bg-gray-50">
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`px-3 py-1 text-xs rounded-full font-bold ${getStatusClass(
            ...
            <div className="p-6 overflow-y-auto space-y-6">
              ...
              <div className="bg-blue-50 rounded-xl p-5 border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-3 flex items-center gap-2">
                  <CheckCircle size={18} /> Cập nhật trạng thái đơn hàng
                </h4>
                <div className="flex flex-col sm:flex-row gap-3">
                  <select
                    id="status-update-select"
                    defaultValue={selectedOrder.order_status}
                    className="flex-1 px-4 py-2 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-700">
      ...
      {showEditStoreModal && editableStoreInfo && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg flex flex-col">
            <div className="flex justify-between items-center px-6 py-4 border-b bg-gray-50">
              <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                <Store size={20} className="text-blue-600" /> Cập nhật thông tin
              </h2>
              <button
            ...
            <div className="p-6">
              <form
                ...
                <div className="bg-yellow-50 p-3 rounded border border-yellow-100 text-xs text-yellow-800">
                  <strong>Lưu ý:</strong> Để thay đổi ảnh đại diện hoặc người
                  quản lý, vui lòng liên hệ Admin hệ thống.
                </div>
              </form>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto">
              <form
                id="promo-form"
                onSubmit={
                  showAddPromoModal ? handleAddPromo : handleUpdatePromo
                }
                className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    value={
                      showAddPromoModal ? newPromo.name : selectedPromo!.name
                    }
                    onChange={
                      showAddPromoModal
                        ? handleNewPromoChange
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value={
                          showAddPromoModal
                            ? newPromo.minimum_pay
                            : selectedPromo!.minimum_pay || ""
                        }
                        onChange={
                          showAddPromoModal
                            ? handleNewPromoChange
                        ...
                        className="bg-white w-full px-3 py-2 border border-gray-300 rounded-lg"
                        placeholder="0"
                      />
                    </div>
                    <div>
            ...
            <div className="px-6 py-4 border-t bg-gray-50 flex justify-end gap-3">
              ...
              <Button
                ...
                form="promo-form"
                className="bg-blue-600 hover:bg-blue-700">
                {showAddPromoModal ? "Tạo khuyến mãi" : "Lưu cập nhật"}
              </Button>
            </div>
          </div>
        </div>
